...
private:
    ...
    // SourceRangeをXMLに変換
    void format_range(const diagnostic::SourceRange& range, std::ostream& out, int indent_level);

    // FixItHintをXMLに変換
    void format_fix_hint(const diagnostic::FixItHint& hint, std::ostream& out, int indent_level);
