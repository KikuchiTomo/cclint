...
const char* token_type_to_string(TokenType type) {
    switch (type) {
        ...
        case TokenType::Consteval: return "consteval";
        case TokenType::Constexpr: return "constexpr";
        case TokenType::Constinit: return "constinit";
        case TokenType::Const_cast: return "const_cast";
        case TokenType::Continue: return "continue";
        case TokenType::Co_await: return "co_await";
        case TokenType::Co_return: return "co_return";
        case TokenType::Co_yield: return "co_yield";
        case TokenType::Decltype: return "decltype";
        case TokenType::Default: return "default";
        case TokenType::Delete: return "delete";
        case TokenType::Do: return "do";
        case TokenType::Double: return "double";
        case TokenType::Dynamic_cast: return "dynamic_cast";
        ...
        case TokenType::Friend: return "friend";
        ...
        case TokenType::Reinterpret_cast: return "reinterpret_cast";
        ...
        case TokenType::Static_cast: return "static_cast";
        case TokenType::Struct: return "struct";
        case TokenType::Switch: return "switch";
        case TokenType::Template: return "template";
        case TokenType::This: return "this";
        case TokenType::Thread_local: return "thread_local";
        ...
        case TokenType::ArrowStar: return "->*";
        ...
        case TokenType::WideCharLiteral: return "WideCharLiteral";
        case TokenType::Utf8CharLiteral: return "Utf8CharLiteral";
        case TokenType::Utf16CharLiteral: return "Utf16CharLiteral";
        case TokenType::Utf32CharLiteral: return "Utf32CharLiteral";
        case TokenType::StringLiteral: return "StringLiteral";
        case TokenType::WideStringLiteral: return "WideStringLiteral";
        case TokenType::Utf8StringLiteral: return "Utf8StringLiteral";
        case TokenType::Utf16StringLiteral: return "Utf16StringLiteral";
        case TokenType::Utf32StringLiteral: return "Utf32StringLiteral";
        case TokenType::RawStringLiteral: return "RawStringLiteral";
        case TokenType::UserDefinedLiteral: return "UserDefinedLiteral";

        // Preprocessor
        case TokenType::PPDirective: return "PPDirective";
        case TokenType::PPInclude: return "#include";
        case TokenType::PPDefine: return "#define";
        case TokenType::PPUndef: return "#undef";
        case TokenType::PPIf: return "#if";
        case TokenType::PPIfdef: return "#ifdef";
        case TokenType::PPIfndef: return "#ifndef";
        case TokenType::PPElif: return "#elif";
        case TokenType::PPElse: return "#else";
        case TokenType::PPEndif: return "#endif";
        case TokenType::PPPragma: return "#pragma";
        case TokenType::PPError: return "#error";
        case TokenType::PPWarning: return "#warning";
        case TokenType::PPLine: return "#line";
        case TokenType::MacroParameter: return "MacroParameter";
        case TokenType::MacroStringify: return "#";
        case TokenType::MacroConcat: return "##";
        ...
        // Attributes
        case TokenType::AttributeStart: return "[[";
        case TokenType::AttributeEnd: return "]]";
